 ...
 */
public class VendorSentToDTO implements Serializable {
    ...
    /* ========== constructors ========== */
    public VendorSentToDTO() { }

    public VendorSentToDTO(String sysPrin, String vendorId, Boolean queForMail, String vendorName) {
